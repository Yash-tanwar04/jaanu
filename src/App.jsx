    ...
    return (
      <div className="lock-screen">
        ...
        <div className="lock-card glass">
          <div className="lock-heart-container" onClick={() => setHeartCount((c) => c + 1)}>
          ...
          {heartCount >= 5 && <p className="secret-reveal">You found it… of course you did 🤍</p>}
        </div>
      </div>
    );
  }
  ...
  if (secondUnlocked) {
    return (
      <div className="letters-page">
        ...
        <h1 className="letters-title">Letters For My Person 🤍</h1>
    ...
    <div className="app-container">
      ...
      <header className="hero">
        ...
        <p className="subtitle">
          ...
          <strong>It’s me choosing you, every single day.</strong>
        </p>
      </header>
      ...
      <section className="section love-game-section">
        <div className="content">
          <div className="love-game glass">
            <h2 className="section-title">A Quick Question 👀</h2>
            {!celebrate ? (
              ...
              <div className="celebrate-box fade-in">
                <h3>YAYYYYY 💕</h3>
                <p>You were always mine and always will be 🤍</p>
              </div>
            )}
          </div>
        </div>
      ...
      <section className="section">
        <div className="content">
          <h2 className="section-title">When We’re Apart 🕊️</h2>
          <div className="card-grid">
            <div className="card glass">Tu mere dimag me rehti hai 24/7.</div>
            <div className="card glass">SaxSux thoughts never stop 😭</div>
            <div className="card glass">I wait to talk to you and spill the tea.</div>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="content">
          <h2 className="section-title">The "I Miss You" Log 💬</h2>
      ...
      <section className="timeline glass-dark">
        <div className="content">
          ...
          <p className="stat-text">Days of pure magic with you</p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="content">
          ...
          <div className="photo-grid">
            <div className="photo-frame"><img src="/p1.jpeg" alt="us" /></div>
            <div className="photo-frame"><img src="/p2.jpeg" alt="us" /></div>
            <div className="photo-frame"><img src="/p3.jpeg" alt="us" /></div>
          </div>
        </div>
      </section>
      ...
      <section className="section secret-section">
        <div className="content">
          <div className="second-lock glass">
            <h2 className="section-title">The Final Secret 👀</h2>
            {!secondUnlocked ? (
              <div className="lock-inner">
                <p>Something only my future wife would know.</p>
                <input
                  className="lock-input"
              ...
              <p className="unlocked-text">Click the letters at the top now 🤍</p>
            )}
          </div>
        </div>
      </section>
      ...
      <footer className="footer">
        <p>Created with love by Yash for his Tannu 💖</p>
      </footer>
    </div>
  );
}
