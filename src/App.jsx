  ...
  if (showRose) {
    return (
      <div className="rose-page">
        ...
        <button className="rose-back" onClick={() => setShowRose(false)}>← Back</button>
...
{`Hello babiee,
see i know how much you love flowers and merko bht bura lag rha h ki i didn't get you a flower,
and but i promise to give you a flower everyday once we are together.
Terko pata h i always think of surprising you randomly with a bunch of flowers or aise flowers jo terko psnd aaye fahhhk
babie i am so sorry ki m terko flowers ni de paata abhi but i will give you flowers wrapped in a lot of love and care.
I will never let you down like everrrr.
Happy Rose day to my Wife to be rn i can only afford a virtual flower
Baaki baate call pe huh.
I LOVE YOU MERI JAAN.`}
  ...
  if (secondUnlocked) {
    const letters = [
      ...
      { id: 3, title: 'Year Changes, We Grow', preview: 'Newwwww Yearrrrr…', full: `Happiest New Year babieeeee 💋❤️❤️❤️... ` }
    ];
    ...
    return (
      <div className="lock-screen">
        ...
        <div className="lock-card glass">
          <div className="lock-heart-container" onClick={() => { setHeartCount(h => h + 1); if (heartCount === 4) confetti({ particleCount: 100 }); }}>
    ...
    <div className="app-container">
      ...
      <header className="hero">
        <div className="title-wrapper glass">
          ...
          <div className="rose-trigger" onClick={() => setShowRose(true)}>🌹 <span>Tap the rose</span></div>
        </div>
        <p className="subtitle">Hey Tannu…<br /><span>This isn’t just a website.</span><br /><strong>It’s me choosing you again.</strong></p>
        <p className="description">Meri KuchhuPuchhu and Wifey | Kattar Man hater</p>
      </header>
      ...
      <section className="section bg-pink">
        <div className="content">
          ...
          <div className={`gift-box ${giftOpen ? 'open' : ''}`} onClick={() => { setGiftOpen(!giftOpen); if(!giftOpen) { confetti({ particleCount: 120 }); giftAudioRef.current.play(); } }}>
            <div className="gift-lid"></div>
            <div className="gift-body"><div className="gift-heart"></div></div>
            <div className="gift-items">
              <div className="bouquet"><div className="flower f1"></div><div className="flower f2"></div><div className="flower f3"></div><div className="stem"></div></div>
              <div className="chocolate"><div className="choco-grid"><span></span><span></span><span></span><span></span></div><div className="choco-label">Chocolate</div></div>
            </div>
          </div>
          <p className="gift-hint">{giftOpen ? "Flowers, chocolate… and all my love 🤍 (Tap to close)" : "Tap the box 👀"}</p>
      ...
      <section className="section">
        <div className="content">
          <div className="second-lock glass">
            ...
            ) : <p className="unlocked-text">Access Granted! Check your letters. 🤍</p>}
          </div>
        </div>
      </section>
